...
|RF007|Filtros de sala|Como usuário, quero filtrar ou pesquisar salas por data, horário, tipo ou local.| | | |Geral|Alta|
...
|RF012|Página do histórico do aluno|Como usuário, quero visualizar uma página de perfil com histórico das minhas reservas.| | | |Geral|Média|
